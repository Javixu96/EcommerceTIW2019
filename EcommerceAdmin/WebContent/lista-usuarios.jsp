                            ...
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-2" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="pages/general.html">Lista de usuarios</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="pages/cards.html">Nuevo usuario<span class="badge badge-secondary">New</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
