...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name"> <!--TODO: Añadir JSP-->John Abraham</h5>
                                </div>
                                <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Cambiar credenciales</a> 
                                <a class="dropdown-item" href="#"><i class="fas fa-power-off mr-2"></i> <!--TODO: Añadir JSP--> Salir</a>
                            </div>
                        </li>
                    </ul>
                </div>
          ...
          <!-- Aquí cargar el menú de la página de index, o al menos copiarlo -->
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-shopping-cart"></i>Compradores</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2">Productos a la venta</h3>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="mr-3 user-avatar-lg rounded" src="assets/images/avatar-1.jpg" alt="Generic placeholder image"> </td>
                                                    <td>Tiger Nixon</td>
