...
import es.uc3m.ecommerce.controller.*;
...
public class FrontController extends HttpServlet {
	...
	@PersistenceContext(unitName = "laboratoriosPU",name = "jpa/pc")
	...
	// Hash table of RequestHandler instances, keyed by request URL
	  ...
	  public void init() throws ServletException {
		...
		handlerHash.put("/insertProduct.html", new es.uc3m.ecommerce.controller.InsertProductHandler());
	  }
