			...
			<div class="row">
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_category"><%=product.getCategoryBean().getCategoryName() %></div>
						<div class="product_name"><%=product.getProductName()%></div>
						<div class="product_text"><%=product.getShortDesc()%></div>
				
						<a href="sendeMessageToSeller.html">Contactar con el vendedor</a>
						<div class="order_info d-flex flex-row">
							<form action="add_to_cart.html" method="POST">
								...
								<%if(request.getAttribute("newProductAdded") != null) { %>
									<span>Este producto ha sido a&ntilde;adido a tu carrito</span>
								<% } %>
								<div class="button_container">
									...
									<button type="submit" class="button cart_button" value="">A&ntilde;adir al carro</button>
								</div>	
								<div class="button_container">
									<a href="<c:url value="wishlist.html">
									    <c:param name="action" value="2"/>
			     						<c:param name="productId" value="${product.getProductId()}"/>
			    	 					</c:url>" class="button cart_button" style="text-decoration: none;"> A&ntilde;adir a mi Wishlist</a>
								</div>
