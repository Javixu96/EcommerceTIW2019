...
<div class="super_container">
			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						<h1 class="banner_text">Lo &uacuteltimo en moda</h1>
						<h5 class="banner_subtitle">Compra tus productos favoritos aqu&iacute</h5>
						<div style="margin-top:140px">Enviamos a todo el mundo</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Gastos de env&iacuteo gratis</div>
							<div class="char_subtitle">a partir de 30&euro;</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Devoluci&oacuten gratis</div>
							<div class="char_subtitle">de 30 d&iacuteas</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Atenci&oacuten al cliente</div>
							<div class="char_subtitle">las 24 h. del d&iacutea</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Promociones nuevas</div>
							<div class="char_subtitle">cada mes</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_category"><a href="#">Camisetas</a></div>
											<div class="deals_item_price_a ml-auto">15.95&euro;</div>
										</div>
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_name">Camiseta lisa</div>
											<div class="deals_item_price ml-auto">9.95&euro;</div>
										</div>
										<div class="available">
											...
											<div class="deals_timer_content ml-auto">
												<div class="deals_timer_box clearfix" data-target-time="">
													<div class="deals_timer_unit">
														<div id="deals_timer1_hr" class="deals_timer_hr" style="text-align:center"></div>
														<p style="font-size: 12px">horas</p>
													</div>
													<div class="deals_timer_unit" style="text-align:center">
														<div id="deals_timer1_min" class="deals_timer_min"></div>
														<p style="font-size: 12px">min</p>
													</div>
													<div class="deals_timer_unit" style="text-align:center">
														<div id="deals_timer1_sec" class="deals_timer_sec"></div>
														<p style="font-size: 12px">seg</p>
													</div>
												</div>
											</div>
										</div>
					...
					<!-- Featured -->
					<div class="featured" style="margin-bottom: 150px">
						<div class="tabbed_container">
							<div class="tabs">
								<ul class="clearfix">
									<li class="active">Destacado</li>
									<li>Rebajas</li>
									<li>Mejores valorados</li>
								</ul>
	...
	<div class="banner_2" style="margin-bottom:50px">
				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						<div class="newsletter_title_container">
							...
							<div class="newsletter_title">Suscr&iacutebete a nuestra newsletter</div>
							<div class="newsletter_text"><p>...y obt&eacuten un cup&oacuten descuento del 20% para la primera compra.</p></div>
						</div>
